...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_APTMAK)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTMAK_FLIP
    #elif defined (MIRYOKU_ALPHAS_APTV3)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTV3_FLIP
    #elif defined (MIRYOKU_ALPHAS_APTV5)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTV5_FLIP
    #elif defined (MIRYOKU_ALPHAS_BIRD)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_BIRD_FLIP
    #elif defined (MIRYOKU_ALPHAS_GALLIUM)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GALLIUM_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_APTMAK)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTMAK
    #elif defined (MIRYOKU_ALPHAS_APTV3)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTV3
    #elif defined (MIRYOKU_ALPHAS_APTV5)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_APTV5
    #elif defined (MIRYOKU_ALPHAS_BIRD)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_BIRD
    #elif defined (MIRYOKU_ALPHAS_GALLIUM)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_APTMAK)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTMAK_FLIP
    #elif defined (MIRYOKU_EXTRA_APTV3)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTV3_FLIP
    #elif defined (MIRYOKU_EXTRA_APTV5)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTV5_FLIP
    #elif defined (MIRYOKU_EXTRA_BIRD)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_BIRD_FLIP
    #elif defined (MIRYOKU_EXTRA_GALLIUM)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GALLIUM_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_APTMAK)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTMAK
    #elif defined (MIRYOKU_EXTRA_APTV3)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTV3
    #elif defined (MIRYOKU_EXTRA_APTV5)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTV5
    #elif defined (MIRYOKU_EXTRA_BIRD)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_BIRD
    #elif defined (MIRYOKU_EXTRA_GALLIUM)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GALLIUM
    #elif defined (MIRYOKU_EXTRA_BEAKL15)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_APTMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTMAK_FLIP
    #elif defined (MIRYOKU_TAP_APTV3)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTV3_FLIP
    #elif defined (MIRYOKU_TAP_APTV5)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTV5_FLIP
    #elif defined (MIRYOKU_TAP_BIRD)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_BIRD_FLIP
    #elif defined (MIRYOKU_TAP_GALLIUM)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GALLIUM_FLIP
    ...
    #elif defined (MIRYOKU_TAP_APTMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTMAK
    #elif defined (MIRYOKU_TAP_APTV3)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTV3
    #elif defined (MIRYOKU_TAP_APTV5)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_APTV5
    #elif defined (MIRYOKU_TAP_BIRD)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_BIRD
    #elif defined (MIRYOKU_TAP_GALLIUM)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GALLIUM
    #elif defined (MIRYOKU_TAP_BEAKL15)
